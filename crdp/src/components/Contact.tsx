...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError("Something went wrong. Please email us directly at crdpartners2020@gmail.com");
    } finally {
      setSending(false);
    }
  };
        ...
        <div className="lg:col-span-5">
          <Reveal>
            ...
            <div className="mt-12 space-y-6">
              ...
              <ContactLine label="Email" value="crdpartners2020@gmail.com" />
              <ContactLine label="Telephone" value="+1 (323) 886-5557" />
            </div>
          </Reveal>
        </div>
          ...
          <Reveal delay={0.1}>
            {sent ? (
              ...
              >
                ...
                {error && (
                  <p className="sm:col-span-2 text-[0.72rem] text-red-600">{error}</p>
                )}
                ...
                <div className="sm:col-span-2">
                  <button
                    type="submit"
                    disabled={sending}
                    className="group relative w-full overflow-hidden bg-ink px-9 py-5 text-[0.7rem] uppercase tracking-luxe text-ivory transition-opacity duration-300 disabled:opacity-60 sm:w-auto"
                  >
